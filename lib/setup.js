...
export function setupCommand() {
  ...
  // Uninstall first to avoid "Please restart VS Code" error on reinstall
  try {
    execSync('code --uninstall-extension remote-clauding.remote-clauding', { stdio: 'ignore' });
  } catch { /* not installed yet, that's fine */ }
